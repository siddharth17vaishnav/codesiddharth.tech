  ...
  return (
    <div className="flex flex-col md:flex-row flex-nowrap">
        ...
        <div>
          <ul className="flex justify-around mx-12 mt-8 gap-3 flex-col md:flex-row pb-7">
            <li className="text-xl text-[#CCF381] ">
              ...
              Engineering with Having experience of building products for client
        ...
        <div className="">
          ...
          <div className="w-[300px] ml-12 mt-4 mb-12">
            ...
            >
              <SwiperSlide>
                {" "}
                <Image src={html} alt="logo" className="w-[50px] h-[30px] " />
              </SwiperSlide>
              <SwiperSlide>
                {" "}
                <Image src={css} alt="logo" className="w-[50px] h-[30px] " />
              </SwiperSlide>
              <SwiperSlide>
                {" "}
                <Image src={js} alt="logo" className="w-[50px] h-[30px]" />
              </SwiperSlide>
              <SwiperSlide>
                {" "}
                <Image src={react} alt="logo" className="w-[50px] h-[30px] " />
              </SwiperSlide>
              <SwiperSlide>
                {" "}
                <Image src={next} alt="logo" className="w-[50px] h-[30px] " />
              </SwiperSlide>
              <SwiperSlide>
                {" "}
                <Image src={node} alt="logo" className="w-[50px] h-[30px] " />
              </SwiperSlide>
              <SwiperSlide>
                {" "}
                <Image
              ...
              <SwiperSlide>
                {" "}
                <Image src={mongo} alt="logo" className="w-[50px] h-[30px] " />
              </SwiperSlide>
              <SwiperSlide>
                {" "}
                <Image
              ...
              <SwiperSlide>
                {" "}
                <Image src={sql} alt="logo" className=" " />
              </SwiperSlide>
            </Swiper>
          </div>
        </div>
      ...
      <div className="w-full h-[800px] lg:h-screen  bg-[#CCF381]  basis-[40%] justify-center my-auto items-center  flex align-center  flex-col">
        ...
        />
        <h1 className="text-2xl font-bold pb-4 text-[#4831D4]">
          Siddharth Vaishnav
        </h1>
      </div>
    </div>
